...
public class MediaFile {
	...
	public static final int FILE_TYPE_PPT = 52;
	public static final int FILE_TYPE_DOC = 53;
	public static final int FILE_TYPE_XLS = 54;
	private static final int FIRST_DOCUMENT_FILE_TYPE = FILE_TYPE_PDF;
	private static final int LAST_DOCUMENT_FILE_TYPE = FILE_TYPE_XLS;
	...
	public static String getMimetype(String path) {
		if(getFileType(path)!=null){
			return getFileType(path).mimeType;
		}
		else{
			return "image/jpeg";
		}
	...
	static {
		...
		//add mine type for microsoft
		addFileType("PPT", FILE_TYPE_PPT, "application/vnd.ms-powerpoint");
		addFileType("PPTX", FILE_TYPE_PPT, "application/vnd.ms-powerpoint");
