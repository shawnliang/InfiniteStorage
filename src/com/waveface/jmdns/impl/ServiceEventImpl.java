...
public class ServiceEventImpl extends ServiceEvent {
     ...
     */
    public ServiceEventImpl(JMDNSImplement jmDNS, String type, String name, ServiceInfo info) {
        super(jmDNS);
        this._type = type;
        this._name = name;
        this._info = info;
    ...
    public ServiceEventImpl clone() {
        ...
        return new ServiceEventImpl((JMDNSImplement) this.getDNS(), this.getType(), this.getName(), newInfo);
    }
