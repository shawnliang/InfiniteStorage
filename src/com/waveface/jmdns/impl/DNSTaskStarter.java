...
import com.waveface.jmdns.impl.tasks.RecordReaper;
import com.waveface.jmdns.impl.tasks.Responder;
import com.waveface.jmdns.impl.tasks.resolver.ServiceInfoResolver;
import com.waveface.jmdns.impl.tasks.resolver.ServiceResolver;
import com.waveface.jmdns.impl.tasks.resolver.TypeResolver;
import com.waveface.jmdns.impl.tasks.state.Announcer;
import com.waveface.jmdns.impl.tasks.state.Canceler;
import com.waveface.jmdns.impl.tasks.state.Prober;
import com.waveface.jmdns.impl.tasks.state.Renewer;
...
public interface DNSTaskStarter {
    ...
    public static final class Factory {
        ...
        private final ConcurrentMap<JMDNSImplement, DNSTaskStarter> _instances;
        ...
        public static interface ClassDelegate {
             ...
             */
            public DNSTaskStarter newDNSTaskStarter(JMDNSImplement jMDNSImplement);
        }
        ...
        private Factory() {
            super();
            _instances = new ConcurrentHashMap<JMDNSImplement, DNSTaskStarter>(20);
        }
         ...
         */
        protected static DNSTaskStarter newDNSTaskStarter(JMDNSImplement jMDNSImplement) {
            DNSTaskStarter instance = null;
            Factory.ClassDelegate delegate = _databaseClassDelegate.get();
            if (delegate != null) {
                instance = delegate.newDNSTaskStarter(jMDNSImplement);
            }
            return (instance != null ? instance : new DNSTaskStarterImpl(jMDNSImplement));
        }
         ...
         */
        public DNSTaskStarter getStarter(JMDNSImplement jMDNSImplement) {
            DNSTaskStarter starter = _instances.get(jMDNSImplement);
            if (starter == null) {
                _instances.putIfAbsent(jMDNSImplement, newDNSTaskStarter(jMDNSImplement));
                starter = _instances.get(jMDNSImplement);
            }
            return starter;
        }
    ...
    public static final class DNSTaskStarterImpl implements DNSTaskStarter {
        ...
        public DNSTaskStarterImpl(JMDNSImplement jMDNSImplement) {
            super();
            _jmDNSImpl = jMDNSImplement;
