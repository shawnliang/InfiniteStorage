...
public class Prober extends DNSStateTask {
    ...
    public Prober(JMDNSImplement jMDNSImplement) {
        super(jMDNSImplement, defaultTTL());
    ...
    public void start(Timer timer) {
        ...
        if (this.getDns().isAnnounced() && this.getDns().getThrottle() < DNSConstants.PROBE_THROTTLE_COUNT) {
            timer.schedule(this, JMDNSImplement.getRandom().nextInt(1 + DNSConstants.PROBE_WAIT_INTERVAL), DNSConstants.PROBE_WAIT_INTERVAL);
