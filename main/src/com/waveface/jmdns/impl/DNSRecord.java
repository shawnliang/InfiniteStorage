...
import com.waveface.jmdns.impl.DNSOutgoing.MessageOutputStream;
...
public abstract class DNSRecord extends DNSEntry {
     ...
     */
    abstract boolean handleQuery(JMDNSImplement dns, long expirationTime);
     ...
     * @return Returns true if a conflict with one of the services registered with JmDNS or with the hostname occured.
     */
    abstract boolean handleResponse(JMDNSImplement dns);

    /**
     * Adds this as an answer to the provided outgoing datagram.
     */
    abstract DNSOutgoing addAnswer(JMDNSImplement dns, DNSIncoming in, InetAddress addr, int port, DNSOutgoing out) throws IOException;
    ...
    public static abstract class Address extends DNSRecord {
         ...
         */
        @Override
        boolean handleQuery(JMDNSImplement dns, long expirationTime) {
         ...
         */
        @Override
        boolean handleResponse(JMDNSImplement dns) {
            if (dns.getLocalHost().conflictWithRecord(this)) {
        ...
        @Override
        DNSOutgoing addAnswer(JMDNSImplement dns, DNSIncoming in, InetAddress addr, int port, DNSOutgoing out) throws IOException {
            return out;
        }
         ...
         */
        @Override
        public ServiceEvent getServiceEvent(JMDNSImplement dns) {
    ...
    public static class Pointer extends DNSRecord {
        ...
        public ServiceEvent getServiceEvent(JMDNSImplement dns) {
            ...
            String serviceName = JMDNSImplement.toUnqualifiedName(domainName, this.getAlias());
     ...
     */
    public abstract ServiceEvent getServiceEvent(JMDNSImplement dns);
