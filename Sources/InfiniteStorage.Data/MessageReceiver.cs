...
namespace InfiniteStorage.Win32
{
	public class MessageReceiver : IDisposable
	{
		...
		/// <summary>
		/// Modifies the User Interface Privilege Isolation (UIPI) message filter to allow msg whose value is greater than WM_USER.
		/// </summary>
		/// <param name="msgType"></param>
		public void AllowMessage(uint msgType)
		{
			NativeMethods.CHANGEFILTERSTRUCT info = new NativeMethods.CHANGEFILTERSTRUCT();
			bool res = NativeMethods.ChangeWindowMessageFilterEx(m_Hwnd, msgType, NativeMethods.ChangeWindowMessageFilterExAction.Allow, ref info);
