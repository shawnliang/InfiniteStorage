...
namespace UnitTest.Pending
{
	...
	public class testPendingToResource
	{
		...
		{
			util.Setup(x=>x.CreateFolder(@"2010\2010-10\title")).Verifiable();
			action.Do(evt);
		...
		{
			evt.title = null;
			util.Setup(x => x.CreateFolder(@"2010\2010-10\2010-10-20 12-40-50 ~ 2010-10-22 11-22-33")).Verifiable();
			action.Do(evt);
		...
		{
			util.Setup(x => x.CreateFolder(@"2010\2010-10\title")).Returns(@"2010\2010-10\title");
			...
			util.Setup(x => x.Move(@".pending\guid", @"dev_folder\2010\2010-10\title\name.jpg")).Returns(@"dev_folder\2010\2010-10\title\name.jpg").Verifiable();
		...
		public void move_record_from_pending_file_tables_to_files_table()
		{
			...
			util.Setup(x => x.Move(@"c:\bunny\.pending\guid", @"c:\bunny\dev_folder\2010\2010-10\title\name.jpg")).Returns(@"c:\bunny\dev_folder\2010\2010-10\title\name.1.jpg");
			...
			Assert.AreEqual(@"2010\2010-10\title", records[0].parent_folder);
			Assert.AreEqual(@"2010\2010-10\title\name.1.jpg", records[0].saved_path);
		}
	}
}
