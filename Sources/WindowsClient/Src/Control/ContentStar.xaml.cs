...
namespace Waveface.Client
{
	public partial class ContentStar : UserControl
	{
		...
		public static readonly DependencyProperty _tagged = DependencyProperty.Register("Tagged", typeof(Boolean), typeof(ContentStar), new UIPropertyMetadata(false, OnTaggedChanged));
